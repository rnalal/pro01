...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script>
    ...
    <style>
       ...
       .page_wrap {padding-top: 80px; text-align:center;}
    ...
    .btn-primary { background: -moz-linear-gradient(top, #ffa600 0%, #ffa600 100%); 
        ...
        background: linear-gradient(to bottom, #ffa600 0%,#ffa600 100%); color:#111; }
    .btn-cancel { background: -moz-linear-gradient(top, #ffcf76 0%, #ffcf76 44%, #ffcf76 100%); 
